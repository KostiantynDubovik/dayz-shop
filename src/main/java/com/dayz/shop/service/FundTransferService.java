...
//		buildFundTransfer(payment);
	...
	private void buildFundWithdraw(Payment payment) {
		...
		putAsString("signature", Utils.getFreekassaSignature(payment), requestObject);
		...
		Map<String, String> response = new RestClient().resource("https://api.freekassa.ru/v1/withdrawals/create").post(Map.class, requestObject);
